...
object EV3AllCollaborationAnalysisScript {
    @JvmStatic
...
//            println(tool)
            ...
            byPLevel.forEach { (pname, pfiles) ->
                ...
                for (file in pfiles) {
                    ...
                    val jsonvalues = json.filter { obj -> obj as JsonObject; obj.getString("first") != key && obj.getString("second") != key }
                ...
                println("${tool}\t${pname}\t${accumulator.format("2.2f")}")
            }
        }
