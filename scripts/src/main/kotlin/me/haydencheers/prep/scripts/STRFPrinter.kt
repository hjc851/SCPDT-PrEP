...
object STRFPrinter {
    ...
    fun main(args: Array<String>) {
        val strfPath = Paths.get("/media/haydencheers/Data/PrEP/Clustering-EV2/SENG1110_A1_2017/p1/out/scores-JPlag.strf")
        val strf = STRFSerialiser.deserialise(strfPath, BatchEvaluationResult::class)

        for (comparison in strf.comparisons.sortedBy { it.similarity }) {
